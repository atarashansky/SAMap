...
class Samap_Iter(object):
    ...
    def run(self,NUMITERS=3,NOPs1=0,NOPs2=0,NH1=2,NH2=2,K=20,NCLUSTERS=1):
        ...
        for i in range(NUMITERS):
            ...
            sam4 = mapper([sam1,sam2],gnnm2,gn,umap=False,K=K,NH1=NH1,NH2=NH2,coarsen=True,key1=self.key1,key2=self.key2)
            ...
            print('ITERATION: ' + str(i),
                  '\nAverage alignment score (A.S.): ',_avg_as(sam4).mean(),
...
def mapper(sams,gnnm,gn,NH1=3,NH2=3,umap=False,mdata=None,k=None,K=20,
...
def _get_pairs(sam1,sam2,gnnm,gn1,gn2,NOPs1=2,NOPs2=5):
    ...
    if NOPs1 == 0 and NOPs2 == 0:
        ...
        B = sparse_knn(gnnm.multiply(W[None,:]).multiply(W[:,None]).tocsr(),NOPs1).tocsr()
